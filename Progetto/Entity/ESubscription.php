...
class ESubscription {  // cod type period price
    ...
    #[ORM\OneToMany(targetEntity: "EPurchase", mappedBy: "idSubscription", cascade: ["persist", "remove"])]  // definisco il nome del campo dell'altra tabella che è chiave esterna
