...
class EPurchase
{
    ...
    #[ORM\JoinColumn(name: "fk_subscription", referencedColumnName: "subscription_id", nullable: true, onDelete: "cascade")]
    private ESubscription $subscription;

    #[ORM\ManyToOne(targetEntity: "ECreditCard", inversedBy: "purchases", cascade: ["persist"])]
    #[ORM\JoinColumn(name: "fk_card", referencedColumnName: "card_number", nullable: false, onDelete: "cascade")]
