...
class VPurchase
{
     ...
     * @return void
     */
    public static function buy(bool $isLogged = false, int $plotPoints = 0, mixed $proPic = null, int $privilege = BASIC, float $points, ESubscription $subscription, ECreditCard $card): void
    {
        $smarty = StartSmarty::configuration();
        ULogSys::toLog("Display -> pagamento.tpl");
        ULogSys::toLog("");
