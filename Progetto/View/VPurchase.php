...
class VPurchase{
    ...
    public static function startPurchase(bool $isLogged = false, int $plotPoints = 0, $proPic = null, bool $isAbbonato = false, ESubscription $subscription, float $poits): void {
