...
class VSearch
{
     ...
     * This method uses Smarty to render the 'ricerca.tpl' template with the provided parameters
     ...
     * @return void
     */
    public static function find(bool $isLogged = false, int $plotPoints = 0, mixed $proPic = null, int $privilege = BASIC)
    {
