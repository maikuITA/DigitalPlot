...
<head>
    ...
    <link rel="stylesheet" href="/Progetto/Smarty/css/modificaprofilo.css" />
        ...
        <div class="card">
            <form action="/confirmEditProfile" method="POST" class="form">
                ...
                <div class="field">
                    ...
                    <p class="control has-icons-left alr">
                        <textarea class="textarea" name="biography" id="c_body">
{$user->getBiography()}</textarea>
                ...
                <div class="field">
                    <div class="control alr">
                        <button class="button is-link is-rounded is-outlined mt-5" type="submit" id="submit-modify">
                            <span>
