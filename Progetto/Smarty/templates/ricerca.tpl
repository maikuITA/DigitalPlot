        ...
        <div class="card">
            ...
            <section class="section">
                <p class="subtitle">
                    ...
                    Oppure, se preferisci, puoi utilizzare i filtri per
                    categoria, genere e data di pubblicazione per affinare
                    la ricerca.
                </p>
    ...
    <div class="container" id="container">
        ...
        <div class="card">
            ...
            <footer class="card-footer">
                <a href="/article/{$article->getId()}" class="card-footer-item">
                    Leggi di più</a>
            </footer>
        </div>
        {/foreach} {/if}
