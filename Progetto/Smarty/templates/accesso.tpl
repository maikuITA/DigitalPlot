        ...
        <div class="body-container">
            <div class="content" id="content">
                ...
                <div class="container">
                    ...
                    <form
                        action="https://digitalplot.altervista.org/registrazione"
                        method="post"
                        class="form regis"
                        id="regis-form"
                    >
                        <label class="title is-3" for="login-form"
                            >Crea il tuo account</label
                        >
                        <div class="grigliata" id="grigliata">
                            ...
                            <div class="field">
                                <p class="control has-icons-left">
                                    ...
                                    placeholder="CAP" name="zipCode"
                                    id="zipCode" {literal} pattern="^\d{5}$"
                                    {/literal} required>
                                    <span
                                        class="icon is-small is-left has-link"
                                    >
                            ...
                            <div class="field">
                                <p class="control has-icons-left">
                                    ...
                                    {literal}
                                    pattern="^\d{1,5}[a-zA-Z]?(\/?[a-zA-Z0-9]+)?$"
                                    {/literal} required>
                                    <span
                                        class="icon is-small is-left has-link"
                                    >
                            ...
                            <div class="field">
                                <p class="control has-icons-left">
                                    ...
                                    id="telephone" {literal}
                                    pattern='^(\+39)?[0-9\s\-]{9,15}$'
                                    {/literal} required>
                                    <span
                                        class="icon is-small is-left has-link"
                                    >
                            ...
                            <div class="field">
                                <p class="control has-icons-left">
                                    ...
                                    {literal}
                                    pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).{8,}$"
                                    {/literal} name="password" id="password"
                                    required />
                                    <span
                                        class="icon is-small is-left has-link"
                                    >
                            ...
                            <div class="field">
                                <p class="control has-icons-left">
                                    ...
                                    {literal}
                                    pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).{8,}$"
                                    {/literal} name="password2" id="password2"
                                    required />
                                    <span
                                        class="icon is-small is-left has-link"
                                    >
