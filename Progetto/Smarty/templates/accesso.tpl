            ...
            <div class="tabs is-medium is-centered">
                <ul>
                    <li id="log" class="is-active">
                        <a onclick="showLogin()"><i class="bi bi-key-fill"></i>Login</a>
                    </li>
                    <li id="reg">
                        <a onclick="showRegis()"><i class="bi bi-person-plus-fill"
                                aria-hidden="true"></i>Registrazione</a>
                    </li>
                </ul>
            </div>
            <div class="container">
                <form action="/checkLogin" method="post" class="form" id="login-form">
                    ...
                    <div class="field">
                        <p class="control has-icons-left alr">
                            <input class="input" type="text" placeholder="Username" name="usernameL" id="username"
                                required />
                ...
                <form action="https://digitalplot.altervista.org/registrazione" method="post" class="form regis"
                    id="regis-form">
                    ...
                    <div class="grigliata" id="grigliata">
                        ...
                        <div class="field">
                            <p class="control has-icons-left">
                                <input class="input" type="text" placeholder="Cognome" name="surname" id="surname"
                                    required />
                                <span class="icon is-small is-left has-link">
                                    <i class="bi bi-person-fill" aria-hidden="true"></i>
                                </span>
                        ...
                        <div class="field">
                            <p class="control has-icons-left">
                                <input class="input" type="text" placeholder="Paese di nascita" name="country"
                                    id="country" required />
                                <span class="icon is-small is-left has-link">
                        ...
                        <div class="field">
                            <p class="control has-icons-left">
                                <input class="input" type="text" placeholder="Luogo di nascita" name="birthplace"
                        ...
                        <div class="field">
                            <p class="control has-icons-left">
                                <input class="input" type="text" placeholder="Provincia" name="province" id="province"
                                    required />
                                <span class="icon is-small is-left has-link">
                                    <i class="bi bi-geo-alt-fill" aria-hidden="true"></i>
                                </span>
                        ...
                        <div class="field">
                            <p class="control has-icons-left">
                                <input class="input" type="text" placeholder="CAP" name="zipCode" id="zipCode" {literal}
                                    pattern="^\d{5}$" {/literal} required>
                                <span class="icon is-small is-left has-link">
                                    <i class="bi bi-geo-alt-fill" aria-hidden="true"></i>
                                </span>
                            </p>
                        ...
                        <div class="field">
                            <p class="control has-icons-left">
                                <input class="input" type="text" placeholder="Indirizzo" name="streetAddress"
                        ...
                        <div class="field">
                            <p class="control has-icons-left">
                                <input class="input" type="text" placeholder="Numero Civico" name="streetNumber"
                                    id="streetNumber" {literal} pattern="^\d{1,5}[a-zA-Z]?(\/?[a-zA-Z0-9]+)?$"
                                    {/literal} required>
                                <span class="icon is-small is-left has-link">
                                    <i class="bi bi-geo-fill" aria-hidden="true"></i>
                                </span>
                        ...
                        <div class="field">
                            <p class="control has-icons-left">
                                <input class="input" type="tel" placeholder="Telefono" name="telephone" id="telephone"
                                    {literal} pattern='^(\+39)?[0-9\s\-]{9,15}$' {/literal} required>
                                <span class="icon is-small is-left has-link">
                        ...
                        <div class="field">
                            <p class="control has-icons-left">
                                <input class="input" type="text" placeholder="Username" name="usernameR" id="usernameR"
                                    required />
                        ...
                        <div class="field">
                            <p class="control has-icons-left">
                                <input class="input" type="email" placeholder="Inserisci la tua email" name="email"
                                    id="email" required />
                                <span class="icon is-small is-left has-link">
                        ...
                        <div class="field is-fullwidth span-all-columns">
                            <p class="has-text-weight-semibold has-text-grey pass">
                                La password deve essere: min. 8 caratteri, almeno una maiuscola, una minuscola e un
                                numero.
                            </p>
                        </div>
                        <div class="field out span-all-columns center-content">
                            <div class="control">
                                <button type="submit" class="button is-link is-fullwidth is centered" id="submit-regis">
                                    Registrati
                                </button>
                            </div>
                        </div>
