            ...
            <div class="tabs is-medium is-centered">
                <ul>
                    <li id="log" class="is-active">
                        <a onclick="showLogin()"><i class="fa fa-key fa-fw"></i>Login</a>
                    </li>
                    <li id="reg">
                        <a onclick="showRegis()"><i class="fa fa-book fa-fw" aria-hidden="true"></i>Registrazione</a>
                    </li>
                </ul>
            </div>
            <div class="container">
                <form action="/checkLogin" method="post" class="form" id="login-form">
                    ...
                    <div class="field">
                        <p class="control has-icons-left alr">
                            <input class="input" type="password" placeholder="Inserisci la tua password" name="password"
                                required />
                            <span class="icon is-small is-left has-link">
                ...
                <form action="https://digitalplot.altervista.org/registrazione" method="post" class="form regis"
                    ...
                    <div class="field out">
                        <div class="control">
                            <button type="submit" class="button is-link is-fullwidth" id="submit-regis">
                                Registrati
                            </button>
                        </div>
                    </div>
