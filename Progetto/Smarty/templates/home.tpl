    ...
    <div class="columns is-centered">
        ...
        <div class="column has-text-right mt-5 ml-0">
            <label class="title is-3">
                puoi ancora leggere {if $remaningReadings < 0} 0 articoli {else} {$remaningReadings} articoli {/if}
                    </label>
        </div>
        {/if}
    </div>
        ...
        <div class="card">
            ...
            <footer class="card-footer">
                <p class="card-footer-item">
                    <a href="/article/{$article->getId()}" class="button is-primary">Leggi di più</a>
                </p>
            </footer>
        </div>
        {/foreach} {/if}
